...
public:
    ...
    sorted_external_vector(uint64_t available_space_bytes,
                           std::function<bool(T const&, T const&)> cmp, std::string tmp_dir,
                           std::string name = "");
    sorted_external_vector(uint64_t available_space_bytes, std::string tmp_dir,
                           std::string name = "");
...
template <typename T>
sorted_external_vector<T>::sorted_external_vector(uint64_t available_space_bytes,
...
template <typename T>
sorted_external_vector<T>::const_iterator::const_iterator()
