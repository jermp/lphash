...
int main(int argc, char* argv[]) {
    ...
    std::size_t total_kmers, check_total_kmers, total_minimizers, total_contigs,
        total_colliding_minimizers, total_distinct_minimizers;
    ...
    {  // garbage collector for unbucketable_kmers
        ...
        //             for (auto itr = unbucketable_kmers.cbegin(); itr !=
        //             unbucketable_kmers.cend(); ++itr) {
        ...
        // 	        assert(it == kmer_check.end()); // if false: there are some duplicates in
        // unbucketable_kmers
        //         }
        // #endif
        {
