...
cmd_line_parser::parser get_build_parser(int argc, char* argv[]) {
    ...
    parser.add("output_filename", "Output file name where the data structure will be serialized (no files generated by default).", "-o", false);
    // parser.add("results_filename",
    //            "CSV file to append to",
    //            "-r",
    //            false);
    parser.add("tmp_dirname", "Temporary directory used for construction in external memory (default is current directory '" + constants::default_tmp_dirname + "').", "-d", false);
    parser.add("c",
