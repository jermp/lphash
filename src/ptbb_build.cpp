...
int main(int argc, char* argv[]) {
	...
	parser.add("pthash_filename", "Output file name where the pthash mphf will be serialized.", "-p", false);
	parser.add("bbhash_filename", "Output file name where the BBHash mphf will be serialized.", "-b", false);
	parser.add("alpha", "The table load factor. It must be a quantity > 0 and <= 1. (default is " + std::to_string(0.94) + ").", "-a", false);
	parser.add("c",
