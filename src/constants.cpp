...
bool operator<(mm_record_t const& a, mm_record_t const& b) { return a.itself < b.itself; }

bool operator>(mm_record_t const& a, mm_record_t const& b) { return a.itself > b.itself; }

bool operator<(mm_triplet_t const& a, mm_triplet_t const& b) { return a.itself < b.itself; }
...
bool operator!=(kmer128_t const& a, kmer128_t const& b) { return not(a == b); }
